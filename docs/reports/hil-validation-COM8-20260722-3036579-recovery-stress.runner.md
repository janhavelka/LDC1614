...
Overall status: `FAIL`
Timestamp UTC: `2026-07-22T17:37:21+00:00`
Host checkout Git commit: `3036579`
Host checkout Git status: `clean`
Library version: `3.0.0`
Firmware version: `3.0.0`
Firmware-reported Git commit: `3036579`
Firmware-reported Git status: `clean`
Expected firmware Git commit: `3036579`
Profile: `arduino`
Fixture: `no-sensor`
Port: `COM8`
Baud: `115200`
...
Notes: ESP-IDF bus-reset post-NACK recovery stress; no MCU reset

## Commands

| # | Command | Status | Elapsed s | Reason |
| ---: | --- | --- | ---: | --- |
| 1 | `version` | `PASS` | 0.016 | all command-specific evidence parsed |
| 2 | `cfg` | `PASS` | 0.031 | all command-specific evidence parsed |
| 3 | `scan` | `PASS` | 0.016 | all command-specific evidence parsed |
| 4 | `busrecover` | `PASS` | 0.015 | status output indicates OK |
| 5 | `init` | `PASS` | 0.063 | all command-specific evidence parsed |
| 6 | `probe` | `PASS` | 0.031 | all command-specific evidence parsed |
| 7 | `reg 0x7E` | `PASS` | 0.016 | all command-specific evidence parsed |
| 8 | `reg 0x7F` | `FAIL` | 0.015 | matched failure pattern: code=[1-9][0-9]* |
| 9 | `version` | `PASS` | 0.032 | all command-specific evidence parsed |
| 10 | `cfg` | `PASS` | 0.015 | all command-specific evidence parsed |
| 11 | `scan` | `PASS` | 0.016 | all command-specific evidence parsed |
| 12 | `busrecover` | `PASS` | 0.016 | status output indicates OK |
| 13 | `init` | `FAIL` | 0.062 | matched failure pattern: code=[1-9][0-9]* |
| 14 | `probe` | `FAIL` | 0.031 | matched failure pattern: code=[1-9][0-9]* |
| 15 | `reg 0x7E` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 16 | `reg 0x7F` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 17 | `version` | `PASS` | 0.031 | all command-specific evidence parsed |
| 18 | `cfg` | `PASS` | 0.015 | all command-specific evidence parsed |
| 19 | `scan` | `PASS` | 0.016 | all command-specific evidence parsed |
| 20 | `busrecover` | `PASS` | 0.031 | status output indicates OK |
...
| 27 | `scan` | `PASS` | 0.015 | all command-specific evidence parsed |
...
| 35 | `scan` | `PASS` | 0.015 | all command-specific evidence parsed |
| 36 | `busrecover` | `PASS` | 0.032 | status output indicates OK |
| 37 | `init` | `PASS` | 0.062 | all command-specific evidence parsed |
| 38 | `probe` | `PASS` | 0.016 | all command-specific evidence parsed |
| 39 | `reg 0x7E` | `PASS` | 0.015 | all command-specific evidence parsed |
| 40 | `reg 0x7F` | `PASS` | 0.032 | all command-specific evidence parsed |
| 41 | `version` | `PASS` | 0.015 | all command-specific evidence parsed |
| 42 | `cfg` | `PASS` | 0.016 | all command-specific evidence parsed |
| 43 | `scan` | `PASS` | 0.031 | all command-specific evidence parsed |
| 44 | `busrecover` | `PASS` | 0.016 | status output indicates OK |
...
| 54 | `probe` | `FAIL` | 0.015 | matched failure pattern: code=[1-9][0-9]* |
...
| 64 | `reg 0x7F` | `FAIL` | 0.031 | matched failure pattern: code=[1-9][0-9]* |
| 65 | `version` | `PASS` | 0.016 | all command-specific evidence parsed |
| 66 | `cfg` | `PASS` | 0.016 | all command-specific evidence parsed |
| 67 | `scan` | `FAIL` | 0.046 | missing command-specific evidence: \bscan complete found=\d+ probes=112\b, \bcode=0\b |
| 68 | `busrecover` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 69 | `init` | `FAIL` | 0.047 | matched failure pattern: code=[1-9][0-9]* |
...
| 100 | `busrecover` | `FAIL` | 0.032 | matched failure pattern: code=[1-9][0-9]* |
| 101 | `init` | `FAIL` | 0.062 | matched failure pattern: code=[1-9][0-9]* |
| 102 | `probe` | `FAIL` | 0.031 | matched failure pattern: code=[1-9][0-9]* |
| 103 | `reg 0x7E` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 104 | `reg 0x7F` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 105 | `version` | `PASS` | 0.031 | all command-specific evidence parsed |
| 106 | `cfg` | `PASS` | 0.015 | all command-specific evidence parsed |
| 107 | `scan` | `PASS` | 0.016 | all command-specific evidence parsed |
| 108 | `busrecover` | `PASS` | 0.031 | status output indicates OK |
| 109 | `init` | `PASS` | 0.047 | all command-specific evidence parsed |
...
| 118 | `probe` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 119 | `reg 0x7E` | `FAIL` | 0.015 | matched failure pattern: code=[1-9][0-9]* |
| 120 | `reg 0x7F` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 121 | `version` | `PASS` | 0.031 | all command-specific evidence parsed |
| 122 | `cfg` | `PASS` | 0.016 | all command-specific evidence parsed |
| 123 | `scan` | `FAIL` | 0.047 | missing command-specific evidence: \bscan complete found=\d+ probes=112\b, \bcode=0\b |
| 124 | `busrecover` | `FAIL` | 0.031 | matched failure pattern: code=[1-9][0-9]* |
| 125 | `init` | `FAIL` | 0.062 | matched failure pattern: code=[1-9][0-9]* |
| 126 | `probe` | `FAIL` | 0.032 | matched failure pattern: code=[1-9][0-9]* |
| 127 | `reg 0x7E` | `FAIL` | 0.015 | matched failure pattern: code=[1-9][0-9]* |
| 128 | `reg 0x7F` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 129 | `version` | `PASS` | 0.015 | all command-specific evidence parsed |
| 130 | `cfg` | `PASS` | 0.032 | all command-specific evidence parsed |
| 131 | `scan` | `PASS` | 0.015 | all command-specific evidence parsed |
| 132 | `busrecover` | `PASS` | 0.016 | status output indicates OK |
| 133 | `init` | `FAIL` | 0.062 | matched failure pattern: code=[1-9][0-9]* |
| 134 | `probe` | `FAIL` | 0.032 | matched failure pattern: code=[1-9][0-9]* |
| 135 | `reg 0x7E` | `FAIL` | 0.015 | matched failure pattern: code=[1-9][0-9]* |
| 136 | `reg 0x7F` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 137 | `version` | `PASS` | 0.031 | all command-specific evidence parsed |
| 138 | `cfg` | `PASS` | 0.016 | all command-specific evidence parsed |
| 139 | `scan` | `PASS` | 0.015 | all command-specific evidence parsed |
| 140 | `busrecover` | `PASS` | 0.016 | status output indicates OK |
| 141 | `init` | `FAIL` | 0.063 | matched failure pattern: code=[1-9][0-9]* |
| 142 | `probe` | `FAIL` | 0.031 | matched failure pattern: code=[1-9][0-9]* |
| 143 | `reg 0x7E` | `FAIL` | 0.015 | matched failure pattern: code=[1-9][0-9]* |
| 144 | `reg 0x7F` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 145 | `version` | `PASS` | 0.031 | all command-specific evidence parsed |
| 146 | `cfg` | `PASS` | 0.016 | all command-specific evidence parsed |
| 147 | `scan` | `PASS` | 0.016 | all command-specific evidence parsed |
| 148 | `busrecover` | `PASS` | 0.015 | status output indicates OK |
| 149 | `init` | `PASS` | 0.063 | all command-specific evidence parsed |
| 150 | `probe` | `PASS` | 0.031 | all command-specific evidence parsed |
| 151 | `reg 0x7E` | `PASS` | 0.016 | all command-specific evidence parsed |
| 152 | `reg 0x7F` | `PASS` | 0.015 | all command-specific evidence parsed |
| 153 | `version` | `PASS` | 0.031 | all command-specific evidence parsed |
| 154 | `cfg` | `PASS` | 0.016 | all command-specific evidence parsed |
| 155 | `scan` | `PASS` | 0.016 | all command-specific evidence parsed |
| 156 | `busrecover` | `PASS` | 0.031 | status output indicates OK |
| 157 | `init` | `FAIL` | 0.047 | matched failure pattern: code=[1-9][0-9]* |
| 158 | `probe` | `FAIL` | 0.031 | matched failure pattern: code=[1-9][0-9]* |
| 159 | `reg 0x7E` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 160 | `reg 0x7F` | `FAIL` | 0.015 | matched failure pattern: code=[1-9][0-9]* |
| 161 | `version` | `PASS` | 0.032 | all command-specific evidence parsed |
| 162 | `cfg` | `PASS` | 0.015 | all command-specific evidence parsed |
| 163 | `scan` | `FAIL` | 0.047 | missing command-specific evidence: \bscan complete found=\d+ probes=112\b, \bcode=0\b |
| 164 | `busrecover` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
...
| 176 | `reg 0x7F` | `FAIL` | 0.031 | matched failure pattern: code=[1-9][0-9]* |
| 177 | `version` | `PASS` | 0.016 | all command-specific evidence parsed |
| 178 | `cfg` | `PASS` | 0.015 | all command-specific evidence parsed |
| 179 | `scan` | `PASS` | 0.032 | all command-specific evidence parsed |
| 180 | `busrecover` | `PASS` | 0.015 | status output indicates OK |
| 181 | `init` | `FAIL` | 0.063 | matched failure pattern: code=[1-9][0-9]* |
| 182 | `probe` | `FAIL` | 0.015 | matched failure pattern: code=[1-9][0-9]* |
| 183 | `reg 0x7E` | `PASS` | 0.016 | all command-specific evidence parsed |
| 184 | `reg 0x7F` | `PASS` | 0.031 | all command-specific evidence parsed |
...
| 188 | `busrecover` | `PASS` | 0.015 | status output indicates OK |
| 189 | `init` | `PASS` | 0.047 | all command-specific evidence parsed |
| 190 | `probe` | `PASS` | 0.016 | all command-specific evidence parsed |
| 191 | `reg 0x7E` | `PASS` | 0.016 | all command-specific evidence parsed |
| 192 | `reg 0x7F` | `PASS` | 0.015 | all command-specific evidence parsed |
| 193 | `version` | `PASS` | 0.031 | all command-specific evidence parsed |
| 194 | `cfg` | `PASS` | 0.016 | all command-specific evidence parsed |
| 195 | `scan` | `FAIL` | 0.047 | missing command-specific evidence: \bscan complete found=\d+ probes=112\b, \bcode=0\b |
| 196 | `busrecover` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 197 | `init` | `FAIL` | 0.046 | matched failure pattern: code=[1-9][0-9]* |
| 198 | `probe` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
| 199 | `reg 0x7E` | `FAIL` | 0.016 | matched failure pattern: code=[1-9][0-9]* |
...
### command 1: version
version: 3.0.0 firmware_git=3036579 firmware_status=clean build_timestamp=2026-07-22 19:36:31
>
### command 2: cfg
...
status: code=5 detail=0 msg=Operation scheduled
> result operation=6 kind=1 outcome=SUCCESS effects=0x00 configRevision=1 phase=11 reg=0x1A channel=255 transfers=26/26
status: code=0 detail=0 msg=OK
...
status: code=17 detail=55 msg=I2C scan probe timed out
> status: code=0 detail=0 msg=OK
>
### command 69: init
...
status: code=17 detail=102 msg=I2C scan probe timed out
> status: code=0 detail=0 msg=OK
>
### command 101: init
...
status: code=17 detail=30 msg=I2C scan probe timed out
> status: code=0 detail=0 msg=OK
>
### command 117: init
...
status: code=17 detail=101 msg=I2C scan probe timed out
> status: code=0 detail=0 msg=OK
>
### command 125: init
...
status: code=5 detail=0 msg=Operation scheduled
> result operation=20 kind=1 outcome=SUCCESS effects=0x00 configRevision=1 phase=11 reg=0x1A channel=255 transfers=26/26
status: code=0 detail=0 msg=OK
...
status: code=17 detail=33 msg=I2C scan probe timed out
> status: code=0 detail=0 msg=OK
>
### command 165: init
...
status: code=5 detail=0 msg=Operation scheduled
> result operation=25 kind=1 outcome=SUCCESS effects=0x00 configRevision=1 phase=11 reg=0x1A channel=255 transfers=26/26
status: code=0 detail=0 msg=OK
...
status: code=17 detail=85 msg=I2C scan probe timed out
>
### command 197: init
status: code=0 detail=0 msg=OK
