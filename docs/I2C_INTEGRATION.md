...
run the ESP-IDF driver's bounded bus reset/line-clear, recreate the device
handle, then require one bounded target-address ACK probe. The reset and probe are owner
