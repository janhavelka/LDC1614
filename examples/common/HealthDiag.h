/**
 * @file HealthDiag.h
 * @brief Verbose health diagnostic helpers for LDC1614 examples.
 *
 ...
 */
inline const char* stateToString(LDC1614::DriverState state) {
  switch (state) {
    case LDC1614::DriverState::UNINIT:   return "UNINIT";
    case LDC1614::DriverState::READY:    return "READY";
    case LDC1614::DriverState::DEGRADED: return "DEGRADED";
    case LDC1614::DriverState::OFFLINE:  return "OFFLINE";
 ...
 */
inline const char* errToString(LDC1614::Err err) {
  switch (err) {
    case LDC1614::Err::OK:                   return "OK";
    case LDC1614::Err::NOT_INITIALIZED:      return "NOT_INITIALIZED";
    ...
    case LDC1614::Err::SENSOR_ERROR:         return "SENSOR_ERROR";
    default:                                  return "UNKNOWN";
  }
}
 ...
 */
inline const char* stateColor(LDC1614::DriverState state) {
  switch (state) {
    case LDC1614::DriverState::READY:    return LOG_COLOR_GREEN;
    case LDC1614::DriverState::DEGRADED: return LOG_COLOR_YELLOW;
    case LDC1614::DriverState::OFFLINE:  return LOG_COLOR_RED;
    case LDC1614::DriverState::UNINIT:   return LOG_COLOR_GRAY;
 ...
 */
inline void printHealthOneLine(LDC1614::LDC1614& driver) {
  LDC1614::DriverState st = driver.state();
 ...
 */
inline void printHealthVerbose(LDC1614::LDC1614& driver) {
  LDC1614::DriverState st = driver.state();
  LDC1614::Status lastErr = driver.lastError();
  uint32_t now = millis();
...
struct HealthSnapshot {
  LDC1614::DriverState state;
  uint8_t consecutiveFailures;
  uint32_t totalSuccess;
  uint32_t totalFailures;
  uint32_t timestamp;

  void capture(LDC1614::LDC1614& driver) {
    state = driver.state();
...
public:
  ...
  void begin(uint32_t intervalMs = 1000) {
    ...
    _lastLogMs = 0;
    _lastState = LDC1614::DriverState::UNINIT;
    _lastConsecFail = 0;
  }
   ...
   */
  void tick(LDC1614::LDC1614& driver, bool forceLog = false) {
    uint32_t now = millis();
    LDC1614::DriverState currentState = driver.state();
...
private:
  ...
  LDC1614::DriverState _lastState = LDC1614::DriverState::UNINIT;
