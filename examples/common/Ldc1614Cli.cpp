...
I2cTransferStats Cli::transferStatsSinceBaseline() const {
...
void Cli::printDiagnostics() const {
...
void Cli::printRegisterValue(uint8_t reg, uint16_t value,
...
LDC1614::Status Cli::scheduleSessionJob(LDC1614::JobKind kind) {
  if (_session.kind == SessionKind::NONE ||
      _pending.owner != OperationOwner::NONE || _device.jobProgress().active) {
    return LDC1614::Status::Error(LDC1614::Err::BUSY,
...
void Cli::advanceDiscoverSession() {
  if (_session.stopRequested) {
    finishSession(LDC1614::Status::Error(LDC1614::Err::CANCELLED,
                                         "CLI session cancelled"),
                  "CANCELLED");
...
void Cli::advanceIdentityStressSession() {
...
void Cli::advanceResetStressSession() {
  if (_session.index >= _session.count) {
...
void Cli::advanceBusFrequencyStressSession() {
